...
class StatsdOutputConfigurationSpec extends Specification {
  ...
  "Loading the configuration" should {
    ...
    "Parse correct configuration" in {
      val soc = OutputConfigurationFactory.getAgentCofiguration("statsd")(StatsdOutputConfiguration.apply)

      soc.prefix mustEqual "monitor"
      soc.remoteAddress mustEqual "localhost.localdomain"
      soc.remotePort mustEqual 1234
